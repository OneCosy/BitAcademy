...
<head>
	...
	<script>
		$(function() {
			$("a#sginIn").click(function(){
				if ($("input[name='id']").val().length == 0) {
					$("p#loginError").html("아이디를 입력해주세요.");
					$("input[name='id']").focus();
				} else if ($("input[type='password']").val().length == 0) {
					$("p#loginError").html("비밀번호를 입력해주세요.");
					...
					$.ajax({
						...
						data: {
							"dataType": "html",
							"cmd": 'login',
							"id": $("input#inputUsernameEmail").val(),
							"pass": $("input#inputPassword").val()
						},
						async: false,
	...
	<div class="container" style="margin-top: 120px">
		<div class="row">
			<div class="main">
				...
				<form role="form" id="login" action="${pageContext.request.contextPath}/login.do?cmd=login" method="post">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<a href="#" id="sginIn" class="btn btn-sm btn-danger btn-block">SIGN IN</a>
						</div>
					</div>
					<div class="login-or">
						<hr class="hr-or">
