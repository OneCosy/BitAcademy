		...
		<div class="col-md-6">
			<table>
				<tr>
					...
					<td class="td2">
						<select id="category" name="category" class="form-control" style="display: inline-block;">
							<option value="">선택해주세요</option>
							<option value="">----------------------</option>
							<option value="카테고리1">JAVA</option>
							<option value="카테고리2">JAVASCRIPT</option>
							<option value="카테고리3">DATABASE</option>
							<option value="카테고리3">SPRING</option>
						</select>
					</td>
				</tr>
						...
						<div class="row row-xs-bskr">
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								...
								<div class="input-forms">
									<input size="20" type="text" id="writer" name="writer" value="" class="form-control input-sm input-name bskr-font user" />
								</div>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-bskr">
								<div class="input-title">비밀번호</div>
								<div class="input-forms">
									<input size="20" type="password" id="pass" name="pass" value="" class="form-control input-sm input-pwd bskr-font user" />
								</div>
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td class="td2" valign="middle">
						<input type="text" id="title" name="title" class="form-control input-sm bskr-font subject" />
					</td>
				</tr>
			</table>
			...
			<div class="form-group">
				<table>
					<tr>
						<td class="td1"></td>
						<td calss="td2">
							<textarea class="form-control col-sm-5" rows="20"></textarea>
						</td>
					</tr>
					<tr>
						<td class="td1"></td>
			...
			<div class="bottombox">
				<input type="button" value="취소" class="btn btn-default btn-sm" onclick="return cancelCheck();" />&nbsp;
