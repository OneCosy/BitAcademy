...
<header class="intro-header" style="background-image: url('img/about-bg.jpg'); height: 200px">
    <div class="container">
        <div class="row">
...
<form action="${pageContext.request.contextPath}/write.do?cmd=write" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
    <div id="write-field">
                        ...
                        <div class="row row-xs-bskr">
                            <div class="col-md-6 col-sm-6 col-xs-bskr">
                                ...
                                <div class="input-forms">
                                    <input size="20" type="text" id="writer" name="writer" value=""
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-bskr">
                                ...
                                <div class="input-forms">
                                    <input size="20" type="password" id="pass" name="pass" value=""
            ...
            <div class="form-group">
                <table>
                    <tr>
                        <td class="td1"></td>
                        <td calss="td2">
                            <textarea name="contents" class="form-control col-sm-5" rows="20"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="td1"></td>
